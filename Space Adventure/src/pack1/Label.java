...
public class Label extends JLabel {
	...
	protected void paintComponent(Graphics g) {
		...
		if(Var.schusskollision == true) {
			g.drawImage(Var.gifexplosion, Var.posgegnerx, Var.posgegnery, 104, 95, null);
		}
		...
		if(Var.imShop) {
			...
			g.drawString("Schuesse", 75, 415);
			g.drawString("Plasmaschild", 75, 485);
			
			g.drawString("Str. "+ Var.up1anzahl, 550, 340);
			g.drawString("Str. "+ Var.up2anzahl, 550, 415);
			g.drawString("Str. "+ Var.up3anzahl, 550, 485);
